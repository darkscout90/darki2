    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertUserBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Users users = Users.get(ChangeActivity.this);

               // users.changeUser( users.findUser(editTextName.getText().toString(),editTextLastName.getText().toString()),editTextName2.getText().toString());
